...
function pagenation($pages = '', $range = 2){
    ...
    if(1 != $pages){
        ...
        // 「前へ」を表示
        if($paged > 1) echo "<div class=\"m-pagination__prev\"><a href='".get_pagenum_link($paged - 1)."'>&lt;</a></div>";
        ...
        // 「次へ」を表示
        if($paged < $pages) echo "<div class=\"m-pagination__next\"><a href='".get_pagenum_link($paged + 1)."'>&gt;</a></div>";
